  	...
  	render: function () {
	    ...
	    return (
	    		<ul>
	    			...
	    			<li className={gamesClass} id="games-offered" key="7">Games Offered: {this.props.casino.games_offered}</li>
	    			<li className={descriptionClass} id="description" key="8">Poker Room Description: {this.props.casino.description}</li>
	    			<li className={specialsClass} id="specials" key="9">Specials and Promotions: {this.props.casino.specials}</li>
	    			<li className={tournamentsClass} id="tournament-info" key="10" onClick={this.getTournaments}>
	      				<Link to={`/${this.props.params.casinos}/${this.props.params.name}/tournaments`}>
				      		View Poker Tournament Info
				      	</Link></li>
	    			<li className={pokerUrlClass} id="poker-url" key="11"><a href={this.props.casino.poker_url}>View Poker Room Site</a></li>
	    			<li className={calendarClass} id="calendar-url" key="12"><a href={this.props.casino.calendar_url}>View Poker Tournament Calendar</a></li>
				</ul>
    	);
  	}
});
