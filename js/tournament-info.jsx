			...
			return (
				<li key={tournament.id}>
					<ul className="tournament">
		    			...
		    			<li className="tournament-prop" id="tourney-start" key="3">Tournament Start Time: {tournament.tourneyStart}</li>
		    			<li className="tournament-prop" id="reg-start" key="4">Registration Start Time: {tournament.regStart}</li>
		    			<li className="tournament-prop" id="reg-end" key="5">Registration End Time: {tournament.regEnd}</li>
		    			...
		    			<li className="tournament-prop" id="rebuy" key="8">Re-buy: {tournament.rebuy}</li>
		      			<li className="tournament-prop" id="add-on" key="9">Add-on: {tournament.addOn}</li>
		      			<li className="tournament-prop" id="bounty" key="10">Bounty: {tournament.bounty}</li>
		      			<li className="tournament-prop" id="prize-gtd" key="11">Prize Guarantee: {tournament.prizeGtd}</li>
		      			<li className="tournament-prop" id="other" key="12">Additional Information: {tournament.other}</li>
					</ul>
				</li>
			);
		})
